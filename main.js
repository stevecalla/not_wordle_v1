...
function createGameStatsMenu() {
  ...
  let row1 = gameStats['1'];
  let row1Width = (135 * (gameStats['1'] / maxWins));
  let row1Percent = gameStats['1'] / gameStats.winCount ? Math.round((gameStats['1'] / gameStats.winCount) * 100) : '0'
