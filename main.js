  ...
  document.getElementById('createGameStatsMenu').innerHTML = `
    ...
    <div class='win-stats-wrapper'>
      ...
      <div class='bars-wrapper'>
        ...
        <p class='row-number'>1</p>
        <progress class='progress-bar' id='' max='${maxWins}' value='${gameStats[row1]}'></progress>
        <p class='win-percent'>${gameStats[row1] / gameStats.winCount ? Math.round((gameStats[row1] / maxWins) * 100) : '0'}%</p>
